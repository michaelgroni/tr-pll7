...
20. Remove the resistor R1 (27 Ohm) on the DRIVE UNIT, which converts part of the power into heat. C1 (470 pF) must be replaced by the value 5.6 pF in order to create an adjustment to 50 Ohm.
