...
void Si5351::enableMultisynthFanout()
{
    constexpr uint8_t ADDRESS = 187;

    auto registerContent = readByte(ADDRESS);

    registerContent &= 0x3F; // clear bits 6 and 7
    registerContent |= 0x10; // set bit 4 to enable multisynth fanout
